...
import static com.netgovpn.freedom.core.utils.V2rayConstants.V2RAY_SERVICE_OPENED_APPLICATION_INTENT;
...
public class NotificationService {
    ...
    public NotificationService(final Service targetService) {
        ...
        @SuppressLint("RestrictedApi") Context context = notifcationBuilder.mContext;
